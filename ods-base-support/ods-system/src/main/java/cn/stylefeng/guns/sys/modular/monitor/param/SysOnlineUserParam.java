 ...
 */
package cn.stylefeng.guns.sys.modular.monitor.param;
...
public class SysOnlineUserParam extends BaseParam {
    ...
    public boolean equals(Object o) {
        ...
        SysOnlineUserParam that = (SysOnlineUserParam) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), sessionId, account, nickName, lastLoginIp, lastLoginTime, lastLoginAddress, lastLoginBrowser, lastLoginOs);
    }
}
