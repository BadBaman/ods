 ...
 */
package cn.stylefeng.guns.sys.modular.role.param;
...
public class SysRoleParam extends BaseParam {
    ...
    public List<Long> getGrantMenuIdList() {
        return grantMenuIdList;
    }

    public void setGrantMenuIdList(List<Long> grantMenuIdList) {
        this.grantMenuIdList = grantMenuIdList;
    }
    ...
    public boolean equals(Object o) {
        ...
        SysRoleParam that = (SysRoleParam) o;
        return Objects.equals(id, that.id) &&
                Objects.equals(name, that.name) &&
                Objects.equals(code, that.code) &&
                Objects.equals(sort, that.sort) &&
                Objects.equals(dataScopeType, that.dataScopeType) &&
                Objects.equals(remark, that.remark) &&
                Objects.equals(grantMenuIdList, that.grantMenuIdList) &&
                Objects.equals(grantOrgIdList, that.grantOrgIdList);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), id, name, code, sort, dataScopeType, remark, grantMenuIdList, grantOrgIdList);
    }
}
