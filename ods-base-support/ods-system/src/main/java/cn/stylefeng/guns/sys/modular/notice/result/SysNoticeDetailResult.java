...
public class SysNoticeDetailResult {
    ...
    public List<Dict> getNoticeUserReadInfoList() {
        return noticeUserReadInfoList;
    }

    public void setNoticeUserReadInfoList(List<Dict> noticeUserReadInfoList) {
        this.noticeUserReadInfoList = noticeUserReadInfoList;
    }
}
