 ...
 */
package cn.stylefeng.guns.sys.modular.emp.param;
...
public class SysEmpParam extends BaseParam {
    ...
    public List<Dict> getExtIds() {
        return extIds;
    }

    public void setExtIds(List<Dict> extIds) {
        this.extIds = extIds;
    }
    ...
    public boolean equals(Object o) {
        ...
        SysEmpParam that = (SysEmpParam) o;
        return Objects.equals(id, that.id) &&
                Objects.equals(jobNum, that.jobNum) &&
                Objects.equals(orgId, that.orgId) &&
                Objects.equals(orgName, that.orgName) &&
                Objects.equals(extIds, that.extIds) &&
                Objects.equals(posIdList, that.posIdList);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), id, jobNum, orgId, orgName, extIds, posIdList);
    }
}
