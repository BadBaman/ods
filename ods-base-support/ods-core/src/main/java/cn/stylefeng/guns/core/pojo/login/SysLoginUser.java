...
public class SysLoginUser implements UserDetails, Serializable {
    ...
    public LoginEmpInfo getLoginEmpInfo() {
        return loginEmpInfo;
    }

    public void setLoginEmpInfo(LoginEmpInfo loginEmpInfo) {
        this.loginEmpInfo = loginEmpInfo;
    }

    public List<Dict> getApps() {
        return apps;
    }

    public void setApps(List<Dict> apps) {
        this.apps = apps;
    }

    public List<Dict> getRoles() {
        return roles;
    }

    public void setRoles(List<Dict> roles) {
        this.roles = roles;
    }
    ...
    public List<LoginMenuTreeNode> getMenus() {
        return menus;
    }

    public void setMenus(List<LoginMenuTreeNode> menus) {
        this.menus = menus;
    }
    ...
    public Dict getTenants() {
        return tenants;
    }

    public void setTenants(Dict tenants) {
